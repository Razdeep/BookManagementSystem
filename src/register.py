...
class Register:
    def __init__(self,master):
        self.master=master
        tkinter.Label(master,text='First name').grid(row=0,column=0)
        self.firstname_entry=tkinter.Entry(master)
        self.firstname_entry.grid(row=0,column=1)
        tkinter.Label(master,text='Last name').grid(row=1,column=0)
        self.lastname_entry=tkinter.Entry(master)
        self.lastname_entry.grid(row=1,column=1)
        tkinter.Label(master,text='Date of Birth').grid(row=2,column=0)
        self.dob=tkinter.Entry(master)
        self.dob.grid(row=2,column=1)
        var=tkinter.IntVar()
        tkinter.Label(master,text='Gender').grid(row=3,column=0)
        self.male_radio=tkinter.Radiobutton(master,text='Male',variable=var,value=1)
        self.female_radio=tkinter.Radiobutton(master,text='Female',variable=var,value=2)
        self.male_radio.grid(row=3,column=1)
        self.female_radio.grid(row=3,column=2)
        tkinter.Label(master,text='Address').grid(row=4,column=0)
        self.address_entry=tkinter.Entry(master)
        self.address_entry.grid(row=4,column=1)
        tkinter.Label(master,text='Contact Number').grid(row=5,column=0)
        self.contact_entry=tkinter.Entry(master)
        self.contact_entry.grid(row=5,column=1)
        tkinter.Label(master,text='Email ID').grid(row=6,column=0)
        self.emailid_entry=tkinter.Entry(master)
        self.emailid_entry.grid(row=6,column=1)
        tkinter.Label(master,text='Password').grid(row=7,column=0)
        self.password_entry=tkinter.Entry(master)
        self.password_entry.grid(row=7,column=1)
        tkinter.Label(master,text='Confirm Password').grid(row=8,column=0)
        self.confirmpassword_entry=tkinter.Entry(master)
        self.confirmpassword_entry.grid(row=8,column=1)
        self.submit_btn=tkinter.Button(master,text='Submit',command=self.submit)
        self.submit_btn.grid(row=9,column=0)
        self.reset_btn=tkinter.Button(master,text='Reset',command=self.reset)
        self.reset_btn.grid(row=9,column=1)
        # For debugging only 
        self.test=tkinter.Button(master,text='Test',command=self.checkEmail)
